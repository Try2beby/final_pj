var promise = [d3.json("./data/group_1.json"), d3.json("./data/group_2.json"), d3.json("./data/group_3.json"), 
...
function update(group){
    ...
    promise[group-1].then(function(loadData){
